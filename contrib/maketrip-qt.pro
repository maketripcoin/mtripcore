...
RESOURCES += src/qt/maketrip.qrc src/qt/maketrip_locale.qrc

TRANSLATIONS += src/qt/locale/maketrip_bg.ts \
                src/qt/locale/maketrip_de.ts \
                src/qt/locale/maketrip_en.ts \
                src/qt/locale/maketrip_es.ts \
                src/qt/locale/maketrip_fi.ts \
                src/qt/locale/maketrip_fr.ts \
                src/qt/locale/maketrip_it.ts \
                src/qt/locale/maketrip_ja.ts \
                src/qt/locale/maketrip_pl.ts \
                src/qt/locale/maketrip_pt.ts \
                src/qt/locale/maketrip_ru.ts \
                src/qt/locale/maketrip_sk.ts \
                src/qt/locale/maketrip_sv.ts \
                src/qt/locale/maketrip_vi.ts \
                src/qt/locale/maketrip_zh_CN.ts \
                src/qt/locale/maketrip_zh_TW.ts
