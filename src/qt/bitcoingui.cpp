                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Maketrip Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MTRIP address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and maketrip: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Maketrip Core"), this);
    aboutAction->setStatusTip(tr("Show information about Maketrip Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Maketrip"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MTRIP addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MTRIP addresses"));
    ...
    openAction->setStatusTip(tr("Open a maketrip: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Maketrip Core help message to get a list with possible Maketrip command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Maketrip Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Maketrip network", "", count));
}
...
{
    QString strTitle = tr("Maketrip Core"); // default title
