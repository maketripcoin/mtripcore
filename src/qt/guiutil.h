...
/** Utility functions used by the Maketrip Qt UI.
 */
namespace GUIUtil
{
...
// Render MTRIP addresses in monospace font
...
// Parse "maketrip:" URI into recipient object, return true on successful parsing
