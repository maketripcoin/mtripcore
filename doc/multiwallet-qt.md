...
In order to support loading of multiple wallets in maketrip-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is maketrip.cpp.
...
Changes to maketrip.cpp
----------------------
maketrip.cpp is the entry point into maketrip-qt, and as such, will require some minor modifications to provide hooks for
