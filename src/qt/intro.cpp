...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Maketrip Core"),
     ...
     * override -datadir in the maketrip.conf file in the default data directory
     * (to be consistent with maketripd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
