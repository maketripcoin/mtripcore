...
Intro
-----
Maketrip (MTRIP) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Maketrip utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run maketrip-qt.exe.

Maketrip Core is the original Maketrip client and it builds the backbone of the network.
However, it downloads and stores the entire history of Maketrip transactions;
