...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Maketrip server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Maketrip server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Maketrip features */
        {"maketrip", "masternode", &masternode, true, true, false},
        {"maketrip", "listmasternodes", &listmasternodes, true, true, false},
        {"maketrip", "getmasternodecount", &getmasternodecount, true, true, false},
        {"maketrip", "masternodeconnect", &masternodeconnect, true, true, false},
        {"maketrip", "masternodecurrent", &masternodecurrent, true, true, false},
        {"maketrip", "masternodedebug", &masternodedebug, true, true, false},
        {"maketrip", "startmasternode", &startmasternode, true, true, false},
        {"maketrip", "createmasternodekey", &createmasternodekey, true, true, false},
        {"maketrip", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"maketrip", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"maketrip", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"maketrip", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"maketrip", "getmasternodescores", &getmasternodescores, true, true, false},
        {"maketrip", "mnbudget", &mnbudget, true, true, false},
        {"maketrip", "preparebudget", &preparebudget, true, true, false},
        {"maketrip", "submitbudget", &submitbudget, true, true, false},
        {"maketrip", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"maketrip", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"maketrip", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"maketrip", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"maketrip", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"maketrip", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"maketrip", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"maketrip", "checkbudgets", &checkbudgets, true, true, false},
        {"maketrip", "mnsync", &mnsync, true, true, false},
        {"maketrip", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> maketrip-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:12332/\n";
}
