Contributing to Maketrip Core
==================================

The Maketrip Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Maketrip Core project, and is not to be
confused with overall Maketrip Network Protocol consensus changes.

Whether a pull request is merged into Maketrip Core rests with the project merge
...
Patches that change Maketrip consensus rules are considerably more involved than
...
Where a patch set proposes to change the Maketrip consensus, it must have been
...
The project leader is the release manager for each Maketrip Core release.
