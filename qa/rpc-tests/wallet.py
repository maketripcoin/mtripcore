...
#   c) node1 mines 32 blocks, so now node 0 has 500000MTRIP, node 1 has 4250MTRIP, node2 has none.
#   d) node0 sends 601 MTRIP to node2, in two transactions (301 MTRIP, then 300 MTRIP).
